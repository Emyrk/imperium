import { Cartographer } from "lib/cartographer/cartographer";
...
Object.defineProperty(RoomPosition.prototype, "name", {
  // identifier for the pos, used in caching
  get: function () {
    return PositionName(this);
  },
  configurable: true
});

export function PositionName(pos: ProtoPos | RoomPosition): string {
...
RoomPosition.prototype.serialize = function (): ProtoPos {
  return {
    x: this.x,
    y: this.y,
